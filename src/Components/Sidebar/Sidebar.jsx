...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-gradient-to-tl from-prim to-accent duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chat/Performance"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-semibold text-bodydark1 duration-300 ease-in-out hover:bg-primHover dark:hover:bg-meta-4 ${
                    pathname.includes("chat/Performance") && "bg-primHover dark:bg-meta-4"
                  }`}
                >
                  <BsChatLeftText />
                  Performance Chat
              ...
              <li>
                <NavLink
                  to="/chat/KRA"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-semibold text-bodydark1 duration-300 ease-in-out hover:bg-primHover dark:hover:bg-meta-4 ${
                    pathname.includes("chat/KRA") && "bg-primHover dark:bg-meta-4"
                  }`}
                >
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/KRAs" || pathname.includes("KRAs")
                }
              >
                {(handleClick, open) => {
                  return (
